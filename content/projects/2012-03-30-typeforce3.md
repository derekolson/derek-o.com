...
---
{% image "img/projects/typeforce2.jpg" "Close-up of white neon letter X" %}
{% image "img/projects/typeforce1.jpg" "Installation parts, servos and controllers" %}
{% image "img/projects/typeforce3.jpg" "Close-up of servo controlled neon dimmer" %}
{% image "img/projects/typeforce5.jpg" "White neon X with viewer in front of it" %}
{% image "img/projects/typeforce6.jpg" "Wide-view of entire typeforce XXX installation" %}
