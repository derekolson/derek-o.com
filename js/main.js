		...
		$.ajax({
        	...
        	success: function(response, success, videoWrapper){
        		...
        		videoWrapper.on('click', function(){
            		...
            		$(this).html('<iframe id="player'+id+'" src="//player.vimeo.com/video/'+id+'?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1&amp;api=1" width="960" frameborder="0" webkitAllowFullScreen mozallowfullscreen autoPlay allowFullScreen></iframe>');
